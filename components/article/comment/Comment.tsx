    ...
    <div>
      <div className="flex items-center bg-gray-50 px-3 py-1 dark:bg-gray-700">
        ...
        <div className="flex w-full flex-col mx-4">
          <span className="block w-full rounded-lg border border-gray-300 bg-gray-200 p-2.5 text-sm text-gray-900 focus:border-blue-500 focus:ring-blue-500 dark:border-gray-600 dark:bg-gray-800 dark:text-white dark:placeholder:text-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500">
            {props.contents}
          </span>
          <div>

import {
  ...
  const MarkdownEditor = (props: any) => {
    ...
    const [title, setTitle] = useState(props.title); // 標題
    const [subtitle, setSubtitle] = useState(props.subtitle); // 副標題
    const [markdown, setMarkdown] = useState(props.connects); // 內文

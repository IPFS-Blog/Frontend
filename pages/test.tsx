...
export default function test() {
  ...
  //FIXME: NN 編輯文章
  function editArticle(articleId: any, articleTitle: any, articleSubtitle: any, articleContents: any) {
    router.push({
      pathname: "/me/drafts/[draft]",
      query: { draft: articleId , title: articleTitle, subtitle: articleSubtitle, contents: articleContents},
    });
  }
  ...
  function activebutton(isTrue: any, articleid: any, articleTitle: any, articleSubtitle: any, articleContents: any) {
    if (isTrue) {
      return (
        <div className="flex">
          <button
          ...
          <button
            ...
            onClick={() => editArticle(articleid, articleTitle, articleSubtitle, articleContents)}
          >
            更改狀態
          </button>
          <button
          ...
          <TableBody>
            {Articles.map((item: any) => (
              <StyledTableRow key={item.title}>
                ...
                <StyledTableCell align="left">{activebutton(item.release, item.id, item.title, item.subtitle, item.contents)}</StyledTableCell>
              </StyledTableRow>
            ))}
          </TableBody>
        </Table>
